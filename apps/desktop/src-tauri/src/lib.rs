...
pub fn run() {
    ...
    let builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::local_override_revert_template,
            commands::local_override_rulesets,
            commands::local_override_toggle_ruleset,
            commands::local_override_update_rulesets_now,
            commands::proxies_list,
            commands::proxies_select,
            commands::proxies_test_delay,
            commands::proxies_test_group,
